...
@section('title', 'Trang xem danh sách nhà cung cấp sản phẩm')
...
@section('content')
    ...
    <a href="{{ route('adminProducerAdd') }}" class="btn btn-primary waves-effect waves-light mb-4"><i
                        ...
                        <tbody>
                            @foreach ($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->thumb == 'default.jpg')
                                            <img src="{{ url('uploads/' . $item->thumb) }}" width="100px" class="img-fluid"
                                                alt="{{ $item->name }}">
                                        @else
                                            <img src="{{ url('uploads/producer/' . $item->thumb) }}" width="100px"
                                    ...
                                    <td>
                                        @if ($item->status == 1)
                                            <a href="{{ route('adminProducerStatus', $item->id) }}"
                                    ...
                                    <td>
                                        <a href="{{ route('adminProducerEdit', $item->id) }}"
                                            class="btn btn-warning btn-rounded waves-effect waves-light">
                                            <i class="bx bx-pencil"></i>
                                        </a>

                                        <a href="{{ route('adminProducerDelete', $item->id) }}"
